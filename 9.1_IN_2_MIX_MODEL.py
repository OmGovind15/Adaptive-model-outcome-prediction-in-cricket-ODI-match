...
def feature_engineering(data):
    ...
    data['required_run_rate'] = data['trail_runs'] / (49-(data['over']))
...
results_df.to_excel('IN2_model_details.xlsx', index=False)

# Path to Excel file
excel_path = "IN2_model_details.xlsx"
